...
function obtenerEstadoFormulario($conn) {
    ...
    if ($result->num_rows > 0) {
        ...
        return $row['mostrar_apoyo_sostenible'];
    } else {
...
<body>
    ...
    <?php if ($mostrar_apoyo_sostenible) : ?>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <input type="number" id="numero_documento" name="numero_documento" value="<?php echo htmlspecialchars($numero_documento); ?>" required class="input-field">
            <br><br>
        ...
        <?php else: ?>
        <h2>No hay apoyos sostenibles activos</h2>
    <?php endif; ?>
    </div>
