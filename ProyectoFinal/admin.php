...
// Lógica para Mostrar/Ocultar el Formulario de Apoyo Sostenible
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['toggle_apoyo_sostenible'])) {
    if (isset($_SESSION['mostrar_apoyo_sostenible']) && $_SESSION['mostrar_apoyo_sostenible']) {
        $_SESSION['mostrar_apoyo_sostenible'] = false;
        header("Location: {$_SERVER['PHP_SELF']}");
        exit();
    } else {
        $_SESSION['mostrar_apoyo_sostenible'] = true;
        header("Location: {$_SERVER['PHP_SELF']}");
        exit();
    }
}

// Verificar el estado para mostrar u ocultar el formulario de apoyo sostenible
$mostrar_apoyo_sostenible = (isset($_SESSION['mostrar_apoyo_sostenible']) && $_SESSION['mostrar_apoyo_sostenible']);
...
<body>
    <div class="container">
        ...
        <h2>Formulario Apoyo Sostenible</h2>
            <input type="submit" name="toggle_apoyo_sostenible" value="<?php echo (isset($_SESSION['mostrar_apoyo_sostenible']) && $_SESSION['mostrar_apoyo_sostenible']) ? 'Ocultar Formulario de Apoyo' : 'Mostrar Formulario de Apoyo'; ?>" class="btn-toggle">
        </form>
